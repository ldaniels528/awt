...
import com.microsoft.awt.models.{OperationResult, Submitter, User}
...
class UserService($http: Http) extends Service {
  ...
  /**
    ...
    * @return a promise of a [[com.microsoft.awt.models.User user]]
    */
  ...
  /**
    ...
    * @return a promise of a [[com.microsoft.awt.models.OperationResult result]]
    */
