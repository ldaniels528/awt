...
class PostService($http: Http) extends Service {
  ...
  /**
    ...
    * @param comment the given [[com.microsoft.awt.javascript.models.Comment comment]]
    * @return a promise of a [[com.microsoft.awt.javascript.models.Post post]]
    */
  ...
  /**
    ...
    * @return a promise of the updated [[com.microsoft.awt.javascript.models.Post post]]
    */
  ...
  /**
    ...
    * @param postID    the given post ID
    * @param commentID the given comment ID
    * @param reply     the given [[com.microsoft.awt.javascript.models.Reply comment]]
    * @return a promise of a [[com.microsoft.awt.javascript.models.Post post]]
    */
  ...
  /**
    ...
    * @param post the given [[com.microsoft.awt.javascript.models.Post post]] to create
    * @return a promise of the newly created [[com.microsoft.awt.javascript.models.Post post]]
    */
  ...
  /**
    ...
    * @return a promise of the retrieved [[com.microsoft.awt.javascript.models.Post post]]
    */
  ...
  /**
    * Retrieves all posts
    * @return a promise of an array of [[com.microsoft.awt.javascript.models.Post posts]]
    */
  ...
  /**
    ...
    * @param post the given [[com.microsoft.awt.javascript.models.Post post]] to update
    * @return a promise of the updated [[com.microsoft.awt.javascript.models.Post post]]
    */
  ...
  /**
    ...
    * @return the [[com.microsoft.awt.javascript.models.SharedContent shared content]]
    */
