...
import com.microsoft.awt.javascript.models.{Session, User, UserLike}
import com.microsoft.awt.javascript.services.MySessionService.{INITIAL_GRACE_PERIOD, SESSION_COOKIE_NAME}
...
class MySessionService($rootScope: Scope, $cookies: Cookies, $location: Location, $timeout: Timeout, toaster: Toaster,
  ...
  /**
    ...
    * @param user the given [[com.microsoft.awt.javascript.models.UserLike user]]
  ...
  /**
    ...
    * @param loadedSession the given [[com.microsoft.awt.javascript.models.Session session]]
    */
...
object MySessionService {
  val SESSION_COOKIE_NAME = "AWT_session_id"
